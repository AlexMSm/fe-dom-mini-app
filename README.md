...
1. Create moving mountains (blocks at first), gaps and plane
2. Cause mountains and gap to be random in position
3. Add to detect contact with blocks and create crash animation
4. Add controls to steer the plane up and down
5. Add a booster option to speed up, delay before can be reused
6. Add highscore counter
